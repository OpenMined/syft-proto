...
# source: pysyft/types/syft/v1/id.proto
...
_ID = _descriptor.Descriptor(
  name='Id',
  full_name='pysyft.types.syft.v1.Id',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id_int', full_name='pysyft.types.syft.v1.Id.id_int', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id_str', full_name='pysyft.types.syft.v1.Id.id_str', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='id', full_name='pysyft.types.syft.v1.Id.id',
...
Id = _reflection.GeneratedProtocolMessageType('Id', (_message.Message,), {
  'DESCRIPTOR' : _ID,
  '__module__' : 'pysyft.types.syft.v1.id_pb2'
  # @@protoc_insertion_point(class_scope:pysyft.types.syft.v1.Id)
  })
