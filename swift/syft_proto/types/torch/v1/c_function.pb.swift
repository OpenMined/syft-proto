...
/// torch._C.Function
struct SyftProto_Types_Torch_V1_CFunction {
...
extension SyftProto_Types_Torch_V1_CFunction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CFunction"
  ...
  static func ==(lhs: SyftProto_Types_Torch_V1_CFunction, rhs: SyftProto_Types_Torch_V1_CFunction) -> Bool {
