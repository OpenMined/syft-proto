...
public struct SyftProto_Generic_Pointers_V1_PointerDataset {
...
extension SyftProto_Generic_Pointers_V1_PointerDataset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PointerDataset"
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularBoolField(value: &self.garbageCollectData) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: SyftProto_Generic_Pointers_V1_PointerDataset, rhs: SyftProto_Generic_Pointers_V1_PointerDataset) -> Bool {
