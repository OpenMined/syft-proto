...
public struct SyftProto_Generic_Pointers_V1_PointerPlan {
...
extension SyftProto_Generic_Pointers_V1_PointerPlan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PointerPlan"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "object_id"),
    2: .standard(proto: "location_id"),
    3: .standard(proto: "object_id_at_location"),
    4: .same(proto: "tags"),
    5: .standard(proto: "garbage_collect_data"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularBoolField(value: &self.garbageCollectData) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.garbageCollectData != false {
      try visitor.visitSingularBoolField(value: self.garbageCollectData, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: SyftProto_Generic_Pointers_V1_PointerPlan, rhs: SyftProto_Generic_Pointers_V1_PointerPlan) -> Bool {
