...
extension SyftProto_Execution_V1_Plan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _torchscript: Data = SwiftProtobuf.Internal.emptyData
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._role)
        case 3: try decoder.decodeSingularBoolField(value: &_storage._includeState)
        ...
        case 7: try decoder.decodeSingularBytesField(value: &_storage._torchscript)
        case 8: try decoder.decodeSingularMessageField(value: &_storage._inputTypes)
        default: break
        }
      }
    }
