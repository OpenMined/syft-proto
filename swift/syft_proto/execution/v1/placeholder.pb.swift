...
public struct SyftProto_Execution_V1_Placeholder {
  ...
  public var expectedShape: SyftProto_Types_Syft_V1_Shape {
    get {return _storage._expectedShape ?? SyftProto_Types_Syft_V1_Shape()}
    set {_uniqueStorage()._expectedShape = newValue}
  }
  /// Returns true if `expectedShape` has been explicitly set.
  public var hasExpectedShape: Bool {return _storage._expectedShape != nil}
  /// Clears the value of `expectedShape`. Subsequent reads from it will return its default value.
  public mutating func clearExpectedShape() {_uniqueStorage()._expectedShape = nil}
...
extension SyftProto_Execution_V1_Placeholder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _expectedShape: SyftProto_Types_Syft_V1_Shape? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _expectedShape = source._expectedShape
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularMessageField(value: &_storage._expectedShape)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._expectedShape {
  ...
  public static func ==(lhs: SyftProto_Execution_V1_Placeholder, rhs: SyftProto_Execution_V1_Placeholder) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._expectedShape != rhs_storage._expectedShape {return false}
        return true
      }
