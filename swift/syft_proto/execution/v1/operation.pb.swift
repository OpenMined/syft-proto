...
struct SyftProto_Execution_V1_Operation {
  ...
  var owner: OneOf_Owner? {
    get {return _storage._owner}
    set {_uniqueStorage()._owner = newValue}
  }

  var ownerPointer: SyftProto_Generic_Pointers_V1_PointerTensor {
    get {
  ...
  var ownerPlaceholder: SyftProto_Frameworks_Torch_Tensors_Interpreters_V1_Placeholder {
    get {
  ...
  var ownerTensor: SyftProto_Types_Torch_V1_TorchTensor {
    get {
  ...
  var returnPlaceholders: [SyftProto_Frameworks_Torch_Tensors_Interpreters_V1_Placeholder] {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: SyftProto_Execution_V1_Operation.OneOf_Owner, rhs: SyftProto_Execution_V1_Operation.OneOf_Owner) -> Bool {
      switch (lhs, rhs) {
...
extension SyftProto_Execution_V1_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SyftProto_Execution_V1_Operation, rhs: SyftProto_Execution_V1_Operation) -> Bool {
