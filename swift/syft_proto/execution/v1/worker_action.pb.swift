...
public struct SyftProto_Execution_V1_WorkerAction {
  ...
  public var target: SyftProto_Execution_V1_WorkerAction.OneOf_Target? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: SyftProto_Execution_V1_WorkerAction.OneOf_Target, rhs: SyftProto_Execution_V1_WorkerAction.OneOf_Target) -> Bool {
      switch (lhs, rhs) {
...
extension SyftProto_Execution_V1_WorkerAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerAction"
  ...
  public static func ==(lhs: SyftProto_Execution_V1_WorkerAction, rhs: SyftProto_Execution_V1_WorkerAction) -> Bool {
