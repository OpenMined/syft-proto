...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n)syft_proto/types/torch/v1/parameter.proto\x12\x19syft_proto.types.torch.v1\x1a\"syft_proto/generic/v1/tensor.proto\"\xaa\x01\n\tParameter\x12\x0e\n\x02id\x18\x01 \x01(\x05R\x02id\x12\x35\n\x06tensor\x18\x02 \x01(\x0b\x32\x1d.syft_proto.generic.v1.TensorR\x06tensor\x12#\n\rrequires_grad\x18\x03 \x01(\x08R\x0crequiresGrad\x12\x31\n\x04grad\x18\x04 \x01(\x0b\x32\x1d.syft_proto.generic.v1.TensorR\x04gradb\x06proto3')
  ,
  dependencies=[syft__proto_dot_generic_dot_v1_dot_tensor__pb2.DESCRIPTOR,])
...
_PARAMETER.fields_by_name['tensor'].message_type = syft__proto_dot_generic_dot_v1_dot_tensor__pb2._TENSOR
_PARAMETER.fields_by_name['grad'].message_type = syft__proto_dot_generic_dot_v1_dot_tensor__pb2._TENSOR
