...
# source: syft_proto/generic/v1/tensor.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='syft_proto/generic/v1/tensor.proto',
  package='syft_proto.generic.v1',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\"syft_proto/generic/v1/tensor.proto\x12\x15syft_proto.generic.v1\x1a!syft_proto/types/syft/v1/id.proto\x1a$syft_proto/types/syft/v1/shape.proto\"\xef\x03\n\x06Tensor\x12,\n\x02id\x18\x01 \x01(\x0b\x32\x1c.syft_proto.types.syft.v1.IdR\x02id\x12\x35\n\x05shape\x18\x02 \x01(\x0b\x32\x1f.syft_proto.types.syft.v1.ShapeR\x05shape\x12\x10\n\x03\x62in\x18\x03 \x01(\x0cR\x03\x62in\x12\x33\n\x05\x63hain\x18\x04 \x01(\x0b\x32\x1d.syft_proto.generic.v1.TensorR\x05\x63hain\x12<\n\ngrad_chain\x18\x05 \x01(\x0b\x32\x1d.syft_proto.generic.v1.TensorR\tgradChain\x12\x12\n\x04tags\x18\x06 \x03(\tR\x04tags\x12 \n\x0b\x64\x65scription\x18\x07 \x01(\tR\x0b\x64\x65scription\x12H\n\nserializer\x18\x08 \x01(\x0e\x32(.syft_proto.generic.v1.Tensor.SerializerR\nserializer\"{\n\nSerializer\x12\x1a\n\x16SERIALIZER_UNSPECIFIED\x10\x00\x12\x14\n\x10SERIALIZER_TORCH\x10\x01\x12\x14\n\x10SERIALIZER_NUMPY\x10\x02\x12\x11\n\rSERIALIZER_TF\x10\x03\x12\x12\n\x0eSERIALIZER_ALL\x10\x04\x62\x06proto3')
  ,
...
_TENSOR_SERIALIZER = _descriptor.EnumDescriptor(
  name='Serializer',
  full_name='syft_proto.generic.v1.Tensor.Serializer',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TENSOR = _descriptor.Descriptor(
  name='Tensor',
  full_name='syft_proto.generic.v1.Tensor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft_proto.generic.v1.Tensor.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shape', full_name='syft_proto.generic.v1.Tensor.shape', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='bin', full_name='syft_proto.generic.v1.Tensor.bin', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='chain', full_name='syft_proto.generic.v1.Tensor.chain', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='grad_chain', full_name='syft_proto.generic.v1.Tensor.grad_chain', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='tags', full_name='syft_proto.generic.v1.Tensor.tags', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='syft_proto.generic.v1.Tensor.description', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='serializer', full_name='syft_proto.generic.v1.Tensor.serializer', index=7,
...
_TENSOR.fields_by_name['id'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_id__pb2._ID
_TENSOR.fields_by_name['shape'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_shape__pb2._SHAPE
...
Tensor = _reflection.GeneratedProtocolMessageType('Tensor', (_message.Message,), {
  'DESCRIPTOR' : _TENSOR,
  '__module__' : 'syft_proto.generic.v1.tensor_pb2'
  # @@protoc_insertion_point(class_scope:syft_proto.generic.v1.Tensor)
  })
