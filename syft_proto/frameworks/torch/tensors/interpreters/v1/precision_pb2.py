...
_FIXEDPRECISIONTENSOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='base', full_name='syft_proto.frameworks.torch.tensors.interpreters.v1.FixedPrecisionTensor.base', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='precision_fractional', full_name='syft_proto.frameworks.torch.tensors.interpreters.v1.FixedPrecisionTensor.precision_fractional', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='chain', full_name='syft_proto.frameworks.torch.tensors.interpreters.v1.FixedPrecisionTensor.chain', index=5,
...
_FIXEDPRECISIONTENSOR.fields_by_name['chain'].message_type = syft__proto_dot_generic_dot_v1_dot_tensor__pb2._TENSOR
