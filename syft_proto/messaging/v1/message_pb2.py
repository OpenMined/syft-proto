...
=======
  ...
  serialized_pb=b'\n%syft_proto/messaging/v1/message.proto\x12\x17syft_proto.messaging.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x30syft_proto/execution/v1/computation_action.proto\x1a\x32syft_proto/execution/v1/communication_action.proto\x1a&syft_proto/types/torch/v1/tensor.proto\"\x89\x03\n\x0bSyftMessage\x12\x46\n\x12\x63ontents_empty_msg\x18\x01 \x01(\x0b\x32\x16.google.protobuf.EmptyH\x00R\x10\x63ontentsEmptyMsg\x12X\n\x13\x63ontents_object_msg\x18\x05 \x01(\x0b\x32&.syft_proto.messaging.v1.ObjectMessageH\x00R\x11\x63ontentsObjectMsg\x12\x61\n\x16\x63ontents_operation_msg\x18\x07 \x01(\x0b\x32).syft_proto.messaging.v1.OperationMessageH\x00R\x14\x63ontentsOperationMsg\x12i\n\x1a\x63ontents_communication_msg\x18\n \x01(\x0b\x32).syft_proto.messaging.v1.OperationMessageH\x00R\x18\x63ontentsCommunicationMsgB\n\n\x08\x63ontents\"O\n\rObjectMessage\x12>\n\x06tensor\x18\x01 \x01(\x0b\x32&.syft_proto.types.torch.v1.TorchTensorR\x06tensor\"V\n\x10OperationMessage\x12\x42\n\x06\x61\x63tion\x18\x01 \x01(\x0b\x32*.syft_proto.execution.v1.ComputationActionR\x06\x61\x63tion\"j\n\x14\x43ommunicationMessage\x12R\n\rcommunication\x18\x01 \x01(\x0b\x32,.syft_proto.execution.v1.CommunicationActionR\rcommunicationB&\n$org.openmined.syftproto.messaging.v1b\x06proto3'
...
_COMMUNICATIONMESSAGE = _descriptor.Descriptor(
  name='CommunicationMessage',
  full_name='syft_proto.messaging.v1.CommunicationMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='communication', full_name='syft_proto.messaging.v1.CommunicationMessage.communication', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SYFTMESSAGE.fields_by_name['contents_communication_msg'].message_type = _OPERATIONMESSAGE
>>>>>>> add communication_action and communication_message
...
_OBJECTMESSAGE.fields_by_name['tensor'].message_type = syft__proto_dot_types_dot_torch_dot_v1_dot_tensor__pb2._TORCHTENSOR
_OPERATIONMESSAGE.fields_by_name['action'].message_type = syft__proto_dot_execution_dot_v1_dot_computation__action__pb2._COMPUTATIONACTION
_COMMUNICATIONMESSAGE.fields_by_name['communication'].message_type = syft__proto_dot_execution_dot_v1_dot_communication__action__pb2._COMMUNICATIONACTION
DESCRIPTOR.message_types_by_name['SyftMessage'] = _SYFTMESSAGE
DESCRIPTOR.message_types_by_name['ObjectMessage'] = _OBJECTMESSAGE
DESCRIPTOR.message_types_by_name['OperationMessage'] = _OPERATIONMESSAGE
DESCRIPTOR.message_types_by_name['CommunicationMessage'] = _COMMUNICATIONMESSAGE
>>>>>>> add communication_action and communication_message
...
CommunicationMessage = _reflection.GeneratedProtocolMessageType('CommunicationMessage', (_message.Message,), {
  'DESCRIPTOR' : _COMMUNICATIONMESSAGE,
  '__module__' : 'syft_proto.messaging.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:syft_proto.messaging.v1.CommunicationMessage)
  })
_sym_db.RegisterMessage(CommunicationMessage)
