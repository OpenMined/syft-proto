...
_GETSHAPEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pointer', full_name='syft_proto.messaging.v1.GetShapeMessage.pointer', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ISNONEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pointer', full_name='syft_proto.messaging.v1.IsNoneMessage.pointer', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLANCOMMANDMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='command', full_name='syft_proto.messaging.v1.PlanCommandMessage.command', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='syft_proto.messaging.v1.PlanCommandMessage.id', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='copy', full_name='syft_proto.messaging.v1.PlanCommandMessage.copy', index=2,
...
_SEARCHMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='query_terms', full_name='syft_proto.messaging.v1.SearchMessage.query_terms', index=0,
...
_GETSHAPEMESSAGE.fields_by_name['pointer'].message_type = syft__proto_dot_generic_dot_pointers_dot_v1_dot_pointer__pb2._POINTER
_ISNONEMESSAGE.fields_by_name['pointer'].message_type = syft__proto_dot_generic_dot_pointers_dot_v1_dot_pointer__pb2._POINTER
_OBJECTMESSAGE.fields_by_name['tensor'].message_type = syft__proto_dot_generic_dot_v1_dot_tensor__pb2._TENSOR
...
_PLANCOMMANDMESSAGE.fields_by_name['id'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_id__pb2._ID
