...
_OPERATION_KWARGSENTRY = _descriptor.Descriptor(
  name='KwargsEntry',
  full_name='syft_proto.execution.v1.Operation.KwargsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='syft_proto.execution.v1.Operation.KwargsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='syft_proto.execution.v1.Operation.KwargsEntry.value', index=1,
...
_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='syft_proto.execution.v1.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='command', full_name='syft_proto.execution.v1.Operation.command', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='owner_pointer', full_name='syft_proto.execution.v1.Operation.owner_pointer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='owner_placeholder', full_name='syft_proto.execution.v1.Operation.owner_placeholder', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='owner_tensor', full_name='syft_proto.execution.v1.Operation.owner_tensor', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='args', full_name='syft_proto.execution.v1.Operation.args', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='kwargs', full_name='syft_proto.execution.v1.Operation.kwargs', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='return_ids', full_name='syft_proto.execution.v1.Operation.return_ids', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='return_placeholders', full_name='syft_proto.execution.v1.Operation.return_placeholders', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='owner', full_name='syft_proto.execution.v1.Operation.owner',
...
Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), {
  ...
  'KwargsEntry' : _reflection.GeneratedProtocolMessageType('KwargsEntry', (_message.Message,), {
    ...
    '__module__' : 'syft_proto.execution.v1.operation_pb2'
    # @@protoc_insertion_point(class_scope:syft_proto.execution.v1.Operation.KwargsEntry)
    })
  ,
