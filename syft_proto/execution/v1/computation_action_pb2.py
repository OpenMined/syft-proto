...
_COMPUTATIONACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='kwargs', full_name='syft_proto.execution.v1.ComputationAction.kwargs', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='return_ids', full_name='syft_proto.execution.v1.ComputationAction.return_ids', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='return_placeholders', full_name='syft_proto.execution.v1.ComputationAction.return_placeholders', index=7,
...
_COMPUTATIONACTION.fields_by_name['return_placeholders'].message_type = syft__proto_dot_execution_dot_v1_dot_placeholder__pb2._PLACEHOLDER
