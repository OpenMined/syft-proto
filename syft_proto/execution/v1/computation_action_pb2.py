...
_COMPUTATIONACTION_KWARGSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='syft_proto.execution.v1.ComputationAction.KwargsEntry.value', index=1,
...
_COMPUTATIONACTION = _descriptor.Descriptor(
  ...
  full_name='syft_proto.execution.v1.ComputationAction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='command', full_name='syft_proto.execution.v1.ComputationAction.command', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='target_id', full_name='syft_proto.execution.v1.ComputationAction.target_id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='target_pointer', full_name='syft_proto.execution.v1.ComputationAction.target_pointer', index=2,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='args', full_name='syft_proto.execution.v1.ComputationAction.args', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='kwargs', full_name='syft_proto.execution.v1.ComputationAction.kwargs', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='return_ids', full_name='syft_proto.execution.v1.ComputationAction.return_ids', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='return_placeholder_ids', full_name='syft_proto.execution.v1.ComputationAction.return_placeholder_ids', index=8,
  ...
  nested_types=[_COMPUTATIONACTION_KWARGSENTRY, ],
  enum_types=[
  ],
...
_COMPUTATIONACTION.fields_by_name['return_placeholder_ids'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_placeholder__id__pb2._PLACEHOLDERID
_COMPUTATIONACTION.oneofs_by_name['target'].fields.append(
  _COMPUTATIONACTION.fields_by_name['target_id'])
_COMPUTATIONACTION.fields_by_name['target_id'].containing_oneof = _COMPUTATIONACTION.oneofs_by_name['target']
_COMPUTATIONACTION.oneofs_by_name['target'].fields.append(
...
ComputationAction = _reflection.GeneratedProtocolMessageType('ComputationAction', (_message.Message,), {

  'KwargsEntry' : _reflection.GeneratedProtocolMessageType('KwargsEntry', (_message.Message,), {
    'DESCRIPTOR' : _COMPUTATIONACTION_KWARGSENTRY,
    '__module__' : 'syft_proto.execution.v1.computation_action_pb2'
    # @@protoc_insertion_point(class_scope:syft_proto.execution.v1.ComputationAction.KwargsEntry)
    })
  ,
  'DESCRIPTOR' : _COMPUTATIONACTION,
  '__module__' : 'syft_proto.execution.v1.computation_action_pb2'
  # @@protoc_insertion_point(class_scope:syft_proto.execution.v1.ComputationAction)
  })
_sym_db.RegisterMessage(ComputationAction)
_sym_db.RegisterMessage(ComputationAction.KwargsEntry)


DESCRIPTOR._options = None
_COMPUTATIONACTION_KWARGSENTRY._options = None
