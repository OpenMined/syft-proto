...
from syft_proto.workers.v1 import worker_pb2 as syft__proto_dot_workers_dot_v1_dot_worker__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\"syft_proto/types/syft/v1/arg.proto\x12\x18syft_proto.types.syft.v1\x1a,syft_proto/generic/pointers/v1/pointer.proto\x1a\"syft_proto/generic/v1/tensor.proto\x1a$syft_proto/types/syft/v1/shape.proto\x1a)syft_proto/types/torch/v1/parameter.proto\x1a\"syft_proto/workers/v1/worker.proto\"\xe0\x03\n\x03\x41rg\x12\x1b\n\x08\x61rg_bool\x18\x01 \x01(\x08H\x00R\x07\x61rgBool\x12\x19\n\x07\x61rg_int\x18\x02 \x01(\x05H\x00R\x06\x61rgInt\x12\x1d\n\targ_float\x18\x03 \x01(\x02H\x00R\x08\x61rgFloat\x12\x1f\n\narg_string\x18\x04 \x01(\tH\x00R\targString\x12>\n\narg_worker\x18\x05 \x01(\x0b\x32\x1d.syft_proto.workers.v1.WorkerH\x00R\targWorker\x12>\n\targ_shape\x18\x06 \x01(\x0b\x32\x1f.syft_proto.types.syft.v1.ShapeH\x00R\x08\x61rgShape\x12>\n\narg_tensor\x18\x07 \x01(\x0b\x32\x1d.syft_proto.generic.v1.TensorH\x00R\targTensor\x12J\n\x0b\x61rg_pointer\x18\x08 \x01(\x0b\x32\'.syft_proto.generic.pointers.v1.PointerH\x00R\nargPointer\x12N\n\x0f\x61rg_torch_param\x18\t \x01(\x0b\x32$.syft_proto.types.torch.v1.ParameterH\x00R\rargTorchParamB\x05\n\x03\x61rgb\x06proto3')
  ,
  dependencies=[syft__proto_dot_generic_dot_pointers_dot_v1_dot_pointer__pb2.DESCRIPTOR,syft__proto_dot_generic_dot_v1_dot_tensor__pb2.DESCRIPTOR,syft__proto_dot_types_dot_syft_dot_v1_dot_shape__pb2.DESCRIPTOR,syft__proto_dot_types_dot_torch_dot_v1_dot_parameter__pb2.DESCRIPTOR,syft__proto_dot_workers_dot_v1_dot_worker__pb2.DESCRIPTOR,])
...
_ARG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='arg_worker', full_name='syft_proto.types.syft.v1.Arg.arg_worker', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='arg_shape', full_name='syft_proto.types.syft.v1.Arg.arg_shape', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='arg_tensor', full_name='syft_proto.types.syft.v1.Arg.arg_tensor', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='arg_pointer', full_name='syft_proto.types.syft.v1.Arg.arg_pointer', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='arg_torch_param', full_name='syft_proto.types.syft.v1.Arg.arg_torch_param', index=8,
...
_ARG.fields_by_name['arg_worker'].message_type = syft__proto_dot_workers_dot_v1_dot_worker__pb2._WORKER
_ARG.fields_by_name['arg_shape'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_shape__pb2._SHAPE
_ARG.fields_by_name['arg_tensor'].message_type = syft__proto_dot_generic_dot_v1_dot_tensor__pb2._TENSOR
_ARG.fields_by_name['arg_pointer'].message_type = syft__proto_dot_generic_dot_pointers_dot_v1_dot_pointer__pb2._POINTER
