...
_TORCHTENSOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='shape', full_name='syft_proto.types.torch.v1.TorchTensor.shape', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='contents_data', full_name='syft_proto.types.torch.v1.TorchTensor.contents_data', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='contents_bin', full_name='syft_proto.types.torch.v1.TorchTensor.contents_bin', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='chain', full_name='syft_proto.types.torch.v1.TorchTensor.chain', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='grad_chain', full_name='syft_proto.types.torch.v1.TorchTensor.grad_chain', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='tags', full_name='syft_proto.types.torch.v1.TorchTensor.tags', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='syft_proto.types.torch.v1.TorchTensor.description', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='serializer', full_name='syft_proto.types.torch.v1.TorchTensor.serializer', index=8,
