...
_TENSORDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='syft_proto.types.torch.v1.TensorData.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shape', full_name='syft_proto.types.torch.v1.TensorData.shape', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='dtype', full_name='syft_proto.types.torch.v1.TensorData.dtype', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='is_quantized', full_name='syft_proto.types.torch.v1.TensorData.is_quantized', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='scale', full_name='syft_proto.types.torch.v1.TensorData.scale', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='zero_point', full_name='syft_proto.types.torch.v1.TensorData.zero_point', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='contents_uint8', full_name='syft_proto.types.torch.v1.TensorData.contents_uint8', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='contents_int8', full_name='syft_proto.types.torch.v1.TensorData.contents_int8', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='contents_int16', full_name='syft_proto.types.torch.v1.TensorData.contents_int16', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='contents_int32', full_name='syft_proto.types.torch.v1.TensorData.contents_int32', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='contents_int64', full_name='syft_proto.types.torch.v1.TensorData.contents_int64', index=10,
    ...
    _descriptor.FieldDescriptor(
      name='contents_float16', full_name='syft_proto.types.torch.v1.TensorData.contents_float16', index=11,
    ...
    _descriptor.FieldDescriptor(
      name='contents_float32', full_name='syft_proto.types.torch.v1.TensorData.contents_float32', index=12,
    ...
    _descriptor.FieldDescriptor(
      name='contents_float64', full_name='syft_proto.types.torch.v1.TensorData.contents_float64', index=13,
    ...
    _descriptor.FieldDescriptor(
      name='contents_bool', full_name='syft_proto.types.torch.v1.TensorData.contents_bool', index=14,
    ...
    _descriptor.FieldDescriptor(
      name='contents_qint8', full_name='syft_proto.types.torch.v1.TensorData.contents_qint8', index=15,
    ...
    _descriptor.FieldDescriptor(
      name='contents_quint8', full_name='syft_proto.types.torch.v1.TensorData.contents_quint8', index=16,
    ...
    _descriptor.FieldDescriptor(
      name='contents_qint32', full_name='syft_proto.types.torch.v1.TensorData.contents_qint32', index=17,
    ...
    _descriptor.FieldDescriptor(
      name='contents_bfloat16', full_name='syft_proto.types.torch.v1.TensorData.contents_bfloat16', index=18,
...
_TENSORDATA.fields_by_name['id'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_id__pb2._ID
_TENSORDATA.fields_by_name['shape'].message_type = syft__proto_dot_types_dot_syft_dot_v1_dot_shape__pb2._SHAPE
